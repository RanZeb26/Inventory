                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-end align-items-center mb-3">
                        ...
                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#add_item_Modal">
                          <i class="typcn typcn-plus-outline"></i> Add Customer
                        </button>
                        <!--
    ...
    <tbody>
      ...
      <tr>
        <td class="d-flex align-items-center">
          ...
          <div>
            <div class="fw-bolder" style="font-weight: 900;"> <?= $row['brand'] ?></div>
            <div class="fw-lighter" style="font-style: italic;"> <?= $row['name'] ?></div>
